      ...
      <div className="flex flex-col gap-8">
        {report.components.map((comp, compIndex) => (
          ...
          >
            ...
            <div className="flex flex-wrap gap-x-8 gap-y-4 text-sm mb-6 pb-6 border-b border-white/5">
              <div className="flex items-center gap-2">
                <span className="text-slate-400 flex items-center gap-2"><Layers size={14} /> {t.material}:</span>
                <span className="font-medium text-slate-200">{comp.material}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-slate-400 flex items-center gap-2"><Ruler size={14} /> {t.dimensions}:</span>
                <span className="font-medium text-slate-200">{comp.dimensions}</span>
              </div>
            </div>
