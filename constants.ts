...
export const TRANSLATIONS = {
  uk: {
    ...
    authUserExists: "Користувач з таким email вже існує",
    authRegSuccessTitle: "Реєстрація успішна",
  ...
  pl: {
    ...
    authRequiredField: "To pole jest wymagane.",
    authInvalidCredentials: "Nieprawidłowy adres email lub hasło",
    authUserExists: "Użytkownik o tym adresie email już istnieje",
    authRegSuccessTitle: "Rejestracja zakończona sukcesem",
  ...
  en: {
    ...
    authRequiredField: "This field is required.",
    authInvalidCredentials: "Invalid email or password",
    authUserExists: "User already registered",
    authRegSuccessTitle: "Registration Successful",
